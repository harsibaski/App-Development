    ...
    <footer className="bg-dark text-light p-4">
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-3">
            <Link className="btn active border border-dark">Privacy Policy</Link>
            <br />
            <Link className="btn active border border-dark">Terms and Conditions</Link>
            <br />
            <Link className="btn active border border-dark">FAQ</Link>
           </div>
            <div className="col-md-3">
